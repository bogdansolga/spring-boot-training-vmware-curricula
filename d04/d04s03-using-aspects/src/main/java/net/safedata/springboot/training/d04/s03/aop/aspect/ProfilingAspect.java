package net.safedata.springboot.training.d04.s03.aop.aspect;
...
public class ProfilingAspect {
    ...
    @Around("@annotation(net.safedata.springboot.training.d04.s03.aop.profiling.ExecutionTimeProfiling)")
    ...
    @Around("@annotation(net.safedata.springboot.training.d04.s03.aop.profiling.MemoryProfiling)")
