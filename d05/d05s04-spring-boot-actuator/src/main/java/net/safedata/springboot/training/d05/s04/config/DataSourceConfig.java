package net.safedata.springboot.training.d05.s04.config;

import net.safedata.springboot.training.d05.s04.model.Product;
import net.safedata.springboot.training.d05.s04.service.ProductService;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = "net.safedata.springboot.training.d05.s04.repository")
