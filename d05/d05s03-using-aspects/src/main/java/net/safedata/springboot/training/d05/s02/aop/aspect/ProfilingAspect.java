package net.safedata.springboot.training.d05.s02.aop.aspect;
...
public class ProfilingAspect {
    ...
    @Around("@annotation(net.safedata.springboot.training.d05.s02.aop.profiling.ExecutionTimeProfiling)")
    ...
    @Around("@annotation(net.safedata.springboot.training.d05.s02.aop.profiling.MemoryProfiling)")
