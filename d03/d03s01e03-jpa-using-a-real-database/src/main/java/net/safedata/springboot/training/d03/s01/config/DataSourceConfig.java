...
import net.safedata.springboot.training.d03.s01.service.ProductService;
...
/**
 * A simple {@link jakarta.sql.DataSource} configuration, which:
 * <ul>
 *     <li>configures the JPA repositories, using the {@link EnableJpaRepositories} annotation</li>
 *     <li>inserts a simple {@link Product} in the database, using the auto-configured {@link jakarta.sql.DataSource}</li>
 * </ul>
 */
@Configuration
